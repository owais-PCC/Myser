...
Build is now green end-to-end (`build-ios-simulator` run [31254713089](https://github.com/owais-PCC/Myser/actions/runs/31254713089), ~4.5 minutes) with the Firebase config bundled and confirmed by log.

**Remaining:**
1. Download the fresh artifact, upload to a new Appetize app entry (delete the old broken one), confirm it now boots past the login screen instead of crashing.
